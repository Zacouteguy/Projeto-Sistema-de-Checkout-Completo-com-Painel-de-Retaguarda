...
<head>
  <title>Burguer Devio</title>
  <meta name="format-detection" content="telephone=no">
  <meta name="viewport" content="width=device-width, height=device-height, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">

  <meta http-equiv="content-type" content="text/html;charset=utf-8" />
  <meta name="description" content="Projeto desenvolvido por Argemiro Zacouteguy no curso de Desenvolvimento Web ">
  <meta name="author" content="Argemiro Zacouteguy">
      ...
      <div id='payment' class='payment col-md-6'>
        ...
        <form method="post">
         ...
         <div class="col-md-6">
          ...
          <label for="story">Observações do Pedido:</label><br>
          <textarea id="story" style="resize: none" name="story"rows="2" cols="62">digite aqui...</textarea>
